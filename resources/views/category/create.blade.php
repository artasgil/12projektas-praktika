                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('category.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="category_title" type="text" class="form-control @error('category_title') is-invalid @enderror" name="category_title" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="summernote @error('category_description') is-invalid @enderror" cols="38" rows="5" name="category_description"> </textarea>
